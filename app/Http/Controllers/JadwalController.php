...
class JadwalController extends Controller
{
    ...
    */
    ...
    public function create()
    {
        ...
        return view('jadwal.create', compact('kelas', 'instruktur'));
    }
    ...
    */
    public function store(Request $request)
    {
        ...
        $data = Jadwal::where('id_instruktur','=',$request->id_instruktur)->where('hari','=',$request->hari)->where('waktu','=',$request->waktu)->get();
        $cek = $data->count();
    ...
    public function edit($id){
        ...
        return view('jadwal.edit', compact('kelas','instruktur'))->with('jadwal', $jadwal);
    }    
