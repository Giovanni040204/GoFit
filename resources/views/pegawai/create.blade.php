                            ...
                            <form action="{{ route('pegawai.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="email" class="form-control @error('email_pegawai') is-invalid @enderror" name="email_pegawai" value="{{ old('email_pegawai') }}" placeholder="Masukkan Email Pegawai">
                                        @error('email_pegawai')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="number" class="form-control @error('telepon_pegawai') is-invalid @enderror" name="telepon_pegawai" value="{{ old('telepon_pegawai') }}" placeholder="Masukkan Telepon Pegawai">
