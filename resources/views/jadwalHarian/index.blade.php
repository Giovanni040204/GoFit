                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="{{ route('jadwalHarian.create') }}" class="btn btn-md btn-success mb-3">GENERATE JADWAL HARIAN</a>
                                </div>
                                <div class="col-sm-6">
                                        ...
                                        <tr>
                                            ...
                                            if($item->hari == 'Senin' && $ganti==0){
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    ?>                                                     
                                                    <br><a href="{{ route('jadwalHarian.edit', $item->id) }}" class="btn btn-sm btn-primary">EDIT STATUS</a> 
                                                </td>
                                                <?php
                                                $cek++;
                                            }
